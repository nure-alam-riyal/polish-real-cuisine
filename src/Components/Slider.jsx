...
const Slider = () => {
    return (
      ...
      >
        ...
        <SwiperSlide>
            <div className="bg-slider2 bg-cover h-[600px]">
            <div className="w-full h-full flex items-center justify-center text-center">
        ...
        <SwiperSlide>
            <div className="bg-slider3 bg-cover h-[600px]">
            <div className="w-full h-full flex items-center justify-center text-center">
        ...
        <SwiperSlide>
            <div className="bg-slider4 bg-cover h-[600px]">
            <div className="w-full h-full flex items-center justify-center text-center">
        ...
        <SwiperSlide>
            <div className="bg-slider5 bg-cover h-[600px]">
            <div className="w-full h-full flex items-center justify-center text-center">
        ...
        <SwiperSlide>
            <div className="bg-slider6 bg-cover h-[600px]">
            <div className="w-full h-full flex items-center justify-center text-center">
        ...
        <SwiperSlide>
            <div className="bg-slider7 bg-cover h-[600px]">
            <div className="w-full h-full flex items-center justify-center text-center">
